...
.constant('Constants', {
    ...
    DEFAULT_CURRENCY: localStorage.getItem('insight-currency') || 'PrimeAI'
...
angular.module('insight').config(function($routeProvider) {
  $routeProvider.
    ...
    when('/blocks', {
      ...
      title: 'primeaicoin Blocks solved Today'
    }).
    when('/blocks-date/:blockDate/:startTimestamp?', {
      templateUrl: 'views/block_list.html',
      title: 'primeaicoin Blocks solved '
    }).
    when('/address/:addrStr', {
      templateUrl: 'views/address.html',
      title: 'primeaicoin Address '
    }).
	 when('/charts', {
